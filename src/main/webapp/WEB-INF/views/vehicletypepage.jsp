    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
            ...
            <form:form role="form" modelAttribute="vehicletype" action="/admindrivease/vehicleType/saveType"  method="post">
              <div class="form-group">
				
                  <form:input type="hidden" class="form-control" id="vehicleTypeId" placeholder=""  path="vehicleTypeId"/>
                </div>
                
               <div class="form-group">
				 <label for="exampleInputEmail1">Vehicle Type Name</label>
                  <form:input type="text" class="form-control" id="vehicleTypeName" placeholder="Vehicle Type Name"  path="vehicleTypeName"/>
                </div>
                 
              <div class="box-footer">
              <center>
                <button type="submit" class="btn btn-primary">Submit</button>
                <a href="/admindrivease/vehicleType/typeList"><button type="reset" class="btn btn-primary">Cancel</button></a>
              </center>
              </div>
            </form:form>
          </div>
            ...
            <h3>Vehicle Types List</h3>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:forEach var="vt" items="${typelist}">
                
                <tr>
                 <td><c:out value="${vt.vehicleTypeId}" /></td>
                    <td><c:out value="${vt.vehicleTypeName}" /></td>
                    
                    <td>
                        <a href="/admindrivease/vehicleType/editType/<c:out value='${vt.vehicleTypeId}' />">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/admindrivease/vehicleType/deleteType/<c:out value='${vt.vehicleTypeId}' />">Delete</a>                     
                    </td>
 				</tr>
 				</c:forEach>
                               </tfoot>
