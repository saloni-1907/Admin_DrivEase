 ...
 <%@ include file="adminsidebar.jsp" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form:form role="form" modelAttribute="vehiclemodel" action="/admindrivease/vehicleModel/saveModel"  method="post">
              <div class="box-body">
              <div class="form-group">
				
                  <form:input type="hidden" class="form-control" id="modelId" placeholder=""  path="modelId"/>
                </div>
                <div class="form-group">
					<label>Vehicle Company</label>
					<form:select class="form-control select2" style="width: 100%;" path="companyId">
               ...
               <div class="form-group">
				 <label for="exampleInputEmail1">Vehicle Model Name</label>
                  <form:input type="text" class="form-control" id="modelName" placeholder="Model Name"  path="modelName"/>
                </div>
