...
<title>Manage Vehicle Companies</title>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Manage Vehicle Companies</h1>
			</section>
			<!-- Main content -->
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Vehicle Company Form</h3>
							</div>
							<form:form role="form" modelAttribute="company"
								action="/admindrivease/vehicleCompany/saveCompany" method="post">
								<div class="box-body">
									<div class="form-group">

										<form:input type="hidden" class="form-control" id="companyId"
											placeholder="" path="companyId" />
									</div>

									<div class="form-group">
										<label for="exampleInputEmail1">Vehicle Company Name</label>
										<form:input type="text" class="form-control" id="companyName"
											placeholder="Company Name" path="companyName" />
									</div>

									<div class="box-footer">
										<center>
											<button type="submit" class="btn btn-primary">Submit</button>
											<a href="/admindrivease/vehicleCompany/companyList"><button
						...
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">Vehicle Company List</h3>
							</div>
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<c:forEach var="co" items="${listcompany}">

										<tr>
											<td><c:out value="${co.companyId}" /></td>
											                    
											<td><c:out value="${co.companyName}" /></td>
											                                         
											<td>                        <a
												href="/admindrivease/vehicleCompany/editCompany/<c:out value='${co.companyId}' />">Edit</a>
												                        &nbsp;&nbsp;&nbsp;&nbsp;
												                        <a
												href="/admindrivease/vehicleCompany/deleteCompany/<c:out value='${co.companyId}' />">Delete</a>                     
												                    
											</td>
										</tr>
									</c:forEach>
