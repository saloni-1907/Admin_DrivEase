				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<c:choose>
								<c:when test="${edit}">
									<h3 class="box-title">Update Vehicle Model Form</h3>
								</c:when>
								<c:otherwise>
							...
							<form:form role="form" modelAttribute="vehiclemodel"
								action="/admindrivease/vehicleModel/saveModel" method="post">
								<div class="box-body">
									<div class="form-group">

										<form:input type="hidden" class="form-control" id="modelId"
											placeholder="" path="modelId" />
									</div>
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Vehicle Model Name</label>
										<form:input type="text" class="form-control" id="modelName"
											placeholder="Model Name" path="modelName" />
									</div>

									<div class="box-footer">
										<center>
											<button type="submit" class="btn btn-primary">Submit</button>
											<a href="/admindrivease/vehicleModel/modelList"><button
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<c:forEach var="m" items="${listmodel}">
											...
											<tr>
												<td><c:out value="${m.modelId}" /></td>
												                    
												<td><c:out value="${m.modelName}" /></td>
												                    
												<td><c:out value="${m.vehicleTypeName}" /></td>
												<td><c:out value="${m.companyName}" /></td>                                         
												<td>                        <a
													href="/admindrivease/vehicleModel/editModel/<c:out value='${m.modelId}' />">Edit</a>
													                        &nbsp;&nbsp;&nbsp;&nbsp;
													                        <a
													href="/admindrivease/vehicleModel/deleteModel/<c:out value='${m.modelId}' />">Delete</a>                     
													                    
												</td>
											</tr>
										</c:forEach>
