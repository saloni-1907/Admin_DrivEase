...
                 <td><c:out value="${fb.emailId}" /></td>
                    <td><c:out value="${fb.subject}" /></td>
					<td><c:out value="${fb.message}" /></td>
                    <td><c:out value="${fb.feedbackTime}" /></td>
                 
                    
                    <td>
                        <a href="/admindrivease/feedback/replyFeedback/<c:out value='${fb.feedbackId}' />">Reply</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/admindrivease/feedback/deleteFeedback/<c:out value='${fb.feedbackId}' />">Delete</a>                     
                    </td>
 				</tr>
 				</c:forEach>
                               </tfoot>
