        ...
        <div class="col-xs-12">
          ...
          <div class="add-model" >
            	<form style="border-style:solid;">
            		<fieldset>
            			<h3 align="center">Add New Model</h3>
		            	&ensp;<label>Vehicle Company:</label>&ensp;
		            	<select id="citylist">
		            	<option>Honda</option>
		            	<option>TVS</option>
		            	...
		            	<br><br>
		            	&ensp;<label>Model:</label>&ensp;<input type="text" size="50">&ensp;
		            	<br><br>
		            	&ensp;<input type="submit" value="Add" align="center">
		            	&ensp;<input type="submit" value="Cancel" align="center"><br><br>
           		</fieldset>
