...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  ...
	  <ol class="breadcrumb">
        <li><a href="/admindrivease/admin/addAdmin"><button class="btn btn-primary">Add New Admin</button></a></li>
      </ol>
    </section>
<br>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:forEach var="ad" items="${listadmin}">
                
                <tr>
                 <td><c:out value="${ad.adminId}" /></td>
                    <td><c:out value="${ad.fname}" /></td>
                    <td><c:out value="${ad.lname}" /></td>
                    <td><c:out value="${ad.emailId}" /></td>
                    
                    <td>
                        <a href="/admindrivease/admin/editAdmin/<c:out value='${ad.adminId}' />">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/admindrivease/admin/deleteAdmin/<c:out value='${ad.adminId}' />">Delete</a>                     
                    </td>
 				</tr>
 				</c:forEach>
                               </tfoot>
