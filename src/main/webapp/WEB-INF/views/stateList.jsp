				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box">
							...
							<form:form role="form" modelAttribute="state"
								action="/admindrivease/state/saveState" method="post">
								<div class="box-body">
									<div class="form-group">

										<form:input type="hidden" class="form-control" id="stateId"
											placeholder="" path="stateId" />
									</div>

									<div class="form-group">
										<label for="exampleInputEmail1">State Name</label>
										<form:input type="text" class="form-control" id="stateName" placeholder="State Name" path="stateName" />
									</div>

									<div class="box-footer">
										<center>
											<button type="submit" class="btn btn-primary">Submit</button>
											<a href="/admindrivease/state/stateList"><button
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<c:forEach var="s" items="${liststate}">
										...
										<tr>
											<td><c:out value="${s.stateId}" /></td>
											                    
											<td><c:out value="${s.stateName}" /></td>
											                                         
											<td>                        <a
												href="/admindrivease/state/editState/<c:out value='${s.stateId}' />">Edit</a>
												                        &nbsp;&nbsp;&nbsp;&nbsp;
												                        <a
												href="/admindrivease/state/deleteState/<c:out value='${s.stateId}' />">Delete</a>                     
												                    
											</td>
										</tr>
									</c:forEach>
