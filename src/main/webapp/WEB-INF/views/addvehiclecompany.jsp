  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Vehicle Company</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form:form role="form" modelAttribute="company" action="/admindrivease/vehicleCompany/saveCompany"  method="post">
              <div class="box-body">
              <div class="form-group">
				
                  <form:input type="hidden" class="form-control" id="companyId" placeholder=""  path="companyId"/>
                </div>
                
               <div class="form-group">
				 <label for="exampleInputEmail1">Vehicle Company Name</label>
                  <form:input type="text" class="form-control" id="companyName" placeholder="Company Name"  path="companyName"/>
                </div>
