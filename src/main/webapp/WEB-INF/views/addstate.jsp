 ...
 <%@ include file="adminsidebar.jsp" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form:form role="form" modelAttribute="state" action="/admindrivease/state/savestate"  method="post">
              <div class="box-body">
              <div class="form-group">
				
                  <form:input type="hidden" class="form-control" id="stateid" placeholder=""  path="stateid"/>
                </div>
                
               <div class="form-group">
				 <label for="exampleInputEmail1">State Name</label>
                  <form:input type="text" class="form-control" id="state" placeholder="State Name"  path="state"/>
                </div>
