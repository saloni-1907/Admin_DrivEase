  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       ...
       <ol class="breadcrumb">
        <li><a href="/admindrivease/user/addUser"><button class="btn btn-primary">Add New User</button></a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:forEach var="ad" items="${listuser}">
                
                <tr>
                 <td><c:out value="${ad.userId}" /></td>
                    <td><c:out value="${ad.fname}" /> <c:out value="${ad.lname}" /></td>
                    <td><c:out value="${ad.emailId}" /></td>
					<td><c:out value="${ad.mobileNo}" /></td>
                    <td><c:out value="${ad.dob}" /></td>
					<td><c:out value="${ad.gender}" /></td>
                    
                    <td>
                        <a href="/admindrivease/user/viewUser/<c:out value='${ad.userId}' />">View</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/admindrivease/user/deleteUser/<c:out value='${ad.userId}' />">Delete</a>                     
                    </td>
 				</tr>
 				</c:forEach>
                               </tfoot>
