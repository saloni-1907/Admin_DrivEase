...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="box">
							...
							<form:form role="form" modelAttribute="area"
								action="/admindrivease/area/saveArea" method="post">
								<div class="box-body">
									<div class="form-group">

										<form:input type="hidden" class="form-control" id="areaId"
											placeholder="" path="areaId" />
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<form:select class="form-control select2" style="width: 100%;" 
											id="citiesByState" path="cityId">
											<c:forEach var="c" items="${cityList}">

												<form:option value="${c.cityId}"
													label="${c.cityName}" />
											</c:forEach>
										</form:select>
									</div>
									<div class="form-group">
										...
										<form:input type="text" class="form-control" id="areaName"
											placeholder="Area Name" path="areaName" />
									</div>

									<div class="box-footer">
										<center>
											<button type="submit" class="btn btn-primary">Submit</button>
											<a href="/admindrivease/area/areaList"><button
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										<c:forEach var="a" items="${listarea}">
											...
											<tr>
												<td><c:out value="${a.areaId}" /></td>
												 
												<td><c:out value="${a.areaName}" /></td>
												                   
												<td><c:out value="${a.cityName}" /></td>
												                    
												<td><c:out value="${a.stateName}" /></td>                                         
												<td>                        <a
													href="/admindrivease/area/editArea/<c:out value='${a.areaId}' />">Edit</a>
													                        &nbsp;&nbsp;&nbsp;&nbsp;
													                        <a
													href="/admindrivease/area/deleteArea/<c:out value='${a.areaId}' />">Delete</a>                     
													                    
												</td>
											</tr>
										</c:forEach>
	...
	<script type="text/javascript">
  	$("#stateId").change(function() {
  	    ...
  	    $.ajax({
  	        type: 'GET',
  	        url: "/admindrivease/area/getCities/" + stateId,
