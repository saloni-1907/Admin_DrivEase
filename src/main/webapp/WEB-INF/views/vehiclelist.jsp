...
                    <td><c:out value="${v.lenderName}" /></td>
                 <td><c:out value="${v.vehicleNumber}" /></td>
                    <td><c:out value="${v.companyName}" /></td>
					<td><c:out value="${v.modelName}" /></td>
                    <td><c:out value="${v.availableFrom}" /> to <c:out value="${v.availableTill}" /></td>
                 	<td>Rs.<c:out value="${v.hourlyrent}" />/Hour <br> Rs.<c:out value="${v.dailyRent}" />/Day</td>
                    <td><c:out value="${v.status}" /></td>
                    <td>
                        <a href="/admindrivease/vehicle/viewVehicle/<c:out value='${v.vehicleId}' />">View</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="/admindrivease/vehicle/deleteVehicle/<c:out value='${v.vehicleId}' />">Delete</a>                     
                    </td>
 				</tr>
 				</c:forEach>
                               </tfoot>
