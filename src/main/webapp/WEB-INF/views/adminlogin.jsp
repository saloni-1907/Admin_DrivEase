...
<div class="login-box">
  ...
  <div class="login-logo">
    ...
    <a href="../../index2.html"><b>Driv<i>E</i>ase</b>AdminLTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <p class="login-box-msg">Sign in to start your session</p>
 	 <%
									...
									%>
    <form method="post" action="/admindrivease/admin/loggingIn" modelAttribute="log" >
     
   
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Email ID" name="emailId" id="emailId" path="emailId" />
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" name="password" path="password" id="password" />
    ...
    <a href="/admindrivease/admin/forgotPassword">I forgot my password</a><br>
...
<!-- iCheck -->
<script src="/admindrivease/resources/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
